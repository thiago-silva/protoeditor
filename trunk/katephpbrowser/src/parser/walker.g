  ...
  | #(T_CONST 
        (
          t:T_IDENTIFIER
          {
            ...
            tmp->setLine(t->getLine());
            tmp->setFileURL(m_url);
            parent->addChild(tmp);
          }
        )+
      )
  ...
  : #(T_VARIABLES
      (
        t:T_VARIABLE
        {
          ...
          var->setLine(t->getLine());
          var->setFileURL(m_url);
          list.append(var);
        }
      )+ 
