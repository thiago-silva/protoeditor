...
PerlDebuggerSettingsWidget::PerlDebuggerSettingsWidget(PerlDebuggerSettings* settings, QWidget *parent, const char *name)
...
PerlDebuggerSettingsWidget::~PerlDebuggerSettingsWidget() {}

int PerlDebuggerSettingsWidget::listenPort()
{
  return m_spListenPort->value();
}

bool PerlDebuggerSettingsWidget::enableJIT()
{
  return m_ckEnableJIT->isChecked();
}

bool PerlDebuggerSettingsWidget::sendSuperGlobals() {
  return m_ckSendSuperGlobals->isChecked();
}

bool PerlDebuggerSettingsWidget::breakOnLoad() {
  return m_ckBreakOnLoad->isChecked();
}

void PerlDebuggerSettingsWidget::populate()
{
...
void PerlDebuggerSettingsWidget::setLangEnabled(bool value)
{
...
#include "perldebuggersettingswidget.moc"
