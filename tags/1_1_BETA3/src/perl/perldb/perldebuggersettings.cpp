...
PerlDebuggerSettings::~PerlDebuggerSettings()
{
}

void PerlDebuggerSettings::loadValuesFromWidget()
{
...
DebuggerTab* PerlDebuggerSettings::widget()
{
  if(!m_widget) {
    m_widget = new PerlDebuggerSettingsWidget(this);
  }
  return m_widget;
}
